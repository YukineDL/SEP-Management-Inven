...
@Repository
public class BatchNumberCustomRepositoryImpl implements IBatchNumberCustomRepository {
    @PersistenceContext
    private EntityManager em;

    @Override
    public List<BatchNumberDTO> findAllByInventoryReceiptCode(String inventoryReceiptCode) {
        ...
        query.setParameter("inventoryReceiptCode", inventoryReceiptCode);
        List<Object[]> objects = query.getResultList();
        List<BatchNumberDTO> dtos = new ArrayList<>();
